...
![](figs_%20-%20_Copia/01_table.png)



# Key Figures
INSERT TABELLE DA FILE EXCEL tables_report_cb QUA
...
::: callout-right
In 2023, global LNG demand growth registered a +2% y/y increase, and is
forecasted to rebound with an average growth rate close to 5% in both
2024 and 2025. European and Chinese gas demand will primarily drive this
uprise, as LNG intake is expected to accelerate in the short-term, in
response to expansion of regasification capacity, and to support the
transition from coal. Despite 2024 LNG supply growth being limited
globally, reduced competition between Europe and Asia, and the expected
new capacity entering the market in 2024 and 2025, are likely to
guarantee adequate demand coverage, limiting the potential risk for
supply shortages until winter 2024-2025. Fluctuations in LNG demand from
European and Asian importers, determined by economic activity and
meteorological conditions, and the progress status of the new expected
capacity, will be pivotal in determining the global equilibrium in 2025
and 2026, with growth rate ranging above 7% in the high scenario.
:::
:::
...
was revised slightly lower since record high gas storages should
slowdown demand recovery over the next few months, while the Asian one
was revised higher to account for a faster than expected recovery of
...
::: callout-right
From 2025 onwards, a gradual normalization is anticipated as a result of
the significant deployment of new liquefaction capacity. Assuming a
progressive normalization of the global LNG market alongside an
acceleration of the energy transition, European gas prices are projected
to steadily decrease towards €30/MWh by 2028.
:::
:::
...
contribute to further tightening the market. As a result, CO2 prices are
expected to accelerate, nearing just below 110 €/ton on average by 2030.
:::
:::
...
::: callout-right
We have revised out CO2 price targets downward in the very short term
...
of 2024, resulting from weak demand and cumulative supply surplus.
Consistent with our previous forecasts, we anticipate a rebound in
allowances demand and, consequently, in average prices in the post-2024
period.
:::
:::
