...
northern regions. These infrastructures are projected to be
introduced with some delay compared to the Terna-Arera timeline. 
:::
:::
...
::: callout-right
Under BAU assumption, a progressive reduction of inter-zonal
constraints in the mainland is assumed to take place since 2035. In the
Low scenario, the implementation of the 30 GW Hypergrid infrastructure proposed
by Terna is considered. In the High scenario, instead, the long-term network
