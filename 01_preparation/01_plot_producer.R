...
for (i in 1:length(vec_plot_line)) { #i = 9
    ...
    plot_line = ggplot(dt_line_lg, aes(anni, valori, color = get(c_name), linetype = get(c_name),group = get(c_name))) +
        ...
        theme(panel.grid.major = element_blank(),  
              ...
              axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1, color = "#002E5A"),
              axis.ticks.x = element_blank(),
              axis.text.y = element_text(color = "#002E5A"),
              axis.ticks.y = element_blank(),
              text = element_text(family = "Aptos Narrow"),
              plot.title = element_text(face = "bold"), 
              plot.subtitle = element_text(face = "italic"),
              legend.position = 'top',
              legend.text = element_text(color = "#002E5A"),
...
for (i in 1:length(vec_plot_line)) { #i = 1
    ...
    plot_line = ggplot() +
        ...
        theme(panel.grid.major = element_blank(),  
              panel.grid.minor = element_blank(),
              panel.border = element_blank(),
              axis.text.x = element_text(angle = 0, vjust = 0, hjust = 0.5, color = "#002E5A"),
              axis.ticks.x = element_blank(),
              axis.text.y = element_text(color = "#002E5A"),
              axis.ticks.y = element_blank(),
              text = element_text(family = "Aptos Narrow"),
...
for (i in 1:length(vec_plot_line)) { #i = 1
    ...
    plot_line =
        ...
        theme(panel.grid.major = element_blank(),  
              panel.grid.minor = element_blank(),
              panel.border = element_blank(),
              axis.text.x = element_text(angle = 0, vjust = 0.5, hjust = 1, color = "#002E5A"),
              axis.ticks.x = element_blank(),
              axis.text.y = element_text(color = "#002E5A"),
              axis.ticks.y = element_blank(),
              text = element_text(family = "Aptos Narrow"),
