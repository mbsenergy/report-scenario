...
***The Italian market, while prioritizing renewable energy expansion,
must also navigate the obstacle of sluggish demand. Our demand growth
projections were revised lower, to reflect the limited recovery observed
post-crisis and a partial decoupling from GDP dynamics. Pre-crisis
levels are now expected to be reached only after 2027. In the long-term,
modest demand growth is primarily driven by electrification. Anticipated
declines in gas prices post-2026, as supply tensions ease, are expected
to exert downward pressure on power prices. Concurrently, CCGT
operability is increasingly constrained by low demand and rising RES
production, exacerbating negative Clean Spark Spreads (CSS) and thus
further suppressing electricity price beyond 2030. Although progress in
RES installations remains promising, weak demand poses a significant
challenge to renewable investments, potentially jeopardizing national
installation targets.***

**Italian power demand rose by 2.3% in 2024**, reaching 312.2 TWh,
closely aligning with our IIIQ24 projections (a variance of just 9 GWh).
This marks the **first annual increase since 2018**, excluding the 2021
post-pandemic rebound. **Limited demand growth** reflects
**macroeconomic challenges, delayed electrification, and weak industrial
performance**, with GDP having expanded by only 0.8%, and industrial
output having continued to contract, particularly in energy-intensive
sectors.

Persistent industrial stagnation and modest GDP growth, projected at
+0.9% for 2025, combined with the observed persistence of a **partial
decoupling between economic growth and electricity consumption**,
prompted a **downward revision of our power demand forecast**: -0.4 TWh
in 2025, -1.7 TWh in 2026, and an average reduction of -4.0 TWh annually
beyond 2027 in the Reference scenario. Annual **power demand growth is
now projected at 1.1% for 2025–2030 (3 TWh per year)**. This is a modest
but still notable acceleration, not seen consistently since before 2008.
Consumption is expected to exceed pre-crisis levels (320 TWh) by 2027 in
the Reference scenario.

**Over the medium to long term (2030–2050), demand growth is anticipated
to remain steady**, exceeding 2.5 TWh per year, **driven by the
electrification of final consumption and the development of new
electricity use segments**, which will play an increasingly critical
role in shaping future demand dynamics.
...
thanks to a rebound in hydroelectric generation, which returned to its
historical average at 52 TWh (+30% y/y), and an increase in solar
production, which reached 28 TWh (+14% y/y). The 2024 surge in RES
production was driven by a 19% increase in PV output, having offset a 7%
decline in wind generation. PV production growth resulted from a 6 GW
capacity expansion—exceeding 2023’s 5 GW—and improved irradiation
levels, while wind capacity grew by 600 MW, consistent with the prior
year.

Our **wind installed capacity projections was slightly adjusted by
region** to better align the onshore and offshore development mix with
recent trends. These revisions reflect limited offshore wind development
in the Centre-North region and sustained onshore capacity growth in the
Southern and insular areas. Notably, most offshore wind projects
submitted to MASE in 2023 and 2024 are concentrated in the Southern and
insular regions, with only one project proposed for the Centre-North.

For the short term, **we continue to anticipate a deceleration in RES
penetration growth during 2025 and 2026** , particularly in PV
...
construction activities to ensure eligibility for auction participation.
The FERX Transitorio, designed to ease the transition to the new
auctioning framework, remains in its early implementation phase, with
developers closely monitoring the finalization of BANDI operational
guidelines. Secondly, **regulatory uncertainty persists**, driven by
delays in **regional deliberations on the "Aree Idonee" Decree** and the
complexities introduced by the **Testo Unico sulle Rinnovabili
(TUFER)**. The TUFER, published in its final version in the Gazzetta
Ufficiale, may pose additional challenges for developers. For an
in-depth analysis of its implications, refer to our newsletter
publication (link).

Under the Reference scenario, solar installed capacity is projected to
reach only 51 GW and wind capacity 17 GW by 2030, significantly **below
the PNIEC targets of 80 GW and 28 GW**, respectively. This shortfall is
primarily attributed to **the current permitting pace, which remains
insufficient to achieve the 9–10 GW of annual installations** required
to meet national objectives. Our demand and RES production projections
indicate that **RES generation will cover 49% of Italian electricity demand by 2030**, falling significantly short of the PNIEC target of 63
%.
...
The **PNIEC targets 72 GWh of additional storage capacity by 2030**,
encompassing utility-scale, distributed projects, and their geographical
distribution: **utility-scale development will focus on Southern regions**, where non-programmable renewable generation is most
prevalent, while **distributed capacity will primarily expand in Northern regions**, often integrated with residential and commercial PV
systems.

The storage market in Italy currently factors in a **pipeline of approximately 16 GW of projects**, either authorized or under
evaluation, whose realization will depend significantly on the support
of regulated mechanisms. These include the MACSE auctions, scheduled for
mid-2025, which primarily aim to develop capacity in the South and
Islands, and the Capacity Market, which is expected to drive investments
in the North, where the MACSE allocation will be limited.

Starting in 2025, while larger projects remain under MASE’s
jurisdiction, **Regions will manage authorizations for storage plants up to 200 MW**, which could lead to bottlenecks in the processing of
requests and delay projects eligible for the first MACSE auction.

Our IVQ24 projections employ a refined methodology, now accounting for
the **potential for BESS development within incentivized mechanisms** in
the short and medium term, as well as RES deployment trajectories and
localization over the long term. We consequently revised expectations
higher for utility-scale storage in Southern and insular regions, now
comprising 78% of the total as of 2030. Small-scale storage will lead in
the Northern regions instead, accounting for 60% of the total. Total
BESS capacity, encompassing both small- and utility-scale systems, is
projected to reach **48 GWh by 2030**, a net increase of +41 GWh from
2023 levels.

####PUN expected to decline towards 100 €/MWh only post-2026 with newliquefaction capacity improving the supply-demand balance

In line with IIIQ24 projections, **we anticipate a slight increase in the PUN in 2025 to 112 €/MWh**, driven by potential **tensions in the gas market** and CO2 prices remaining around 85 €/ton, reflecting the
**full implementation of the ETS reform**. However, with the continued
integration of RES capacity, further price normalization post-2026, and
sustained levels of electricity imports, we project **prices to fall below 100 €/MWh by 2029** in the Reference scenario and by 2026 in the
High RES case.

The **annual 2024 PUN average settled at 107.6 €/MWh**, aligning closely
with our IIIQ24 projections (107.8 €/MWh) While this marks a reduction
of approximately 15% compared to the 2023 average of 127 €/MWh, **prices remain elevated relative to pre-crisis levels**.
...
Consequently, the short-term dynamics of power prices are primarily
attributed to developments in the gas market. **In 2024, gas demand stagnated** due to milder winter temperatures reducing heating needs and
a struggling industrial sector yet to recover fully. This **subdued demand facilitated the replenishment of gas storage**, creating an
additional buffer against demand fluctuations. Meanwhile, **gas supply remained stable**, with no significant interruptions, allowing prices to
edge closer to pre-crisis levels.

However, in the short term, **the global LNG market remains defined by a fragile balance** between limited supply and the absence of Russian
pipeline gas, which continues to support European demand. Europe is
adapting its supply mix to the absence of Russian gas, with Norway and
Algeria emerging as key suppliers, while **Italy's high network and transportation tariffs—among the highest in Europe—limit its ability to position itself as an exporting country** to Eastern and Central
European nations, such as Austria, that were most impacted by the
suspension of Russian flows. Prices, currently exceeding €30/MWh, are
unlikely to decline significantly before 2026, when the market awaits
new liquefaction capacity from Qatar and the United States to ease the
global LNG market tightness.

Moreover, **adjustments in gas logistic component** for the 2025–2030
period, including the stabilization of the CRVOS reimbursement
mechanism—which thermoelectric plants can claim and will remain
unchanged for the next five years—and the elimination of the CRVBL
component, previously established to cover gas balancing costs, which
has now been set to zero led to a downward revision of the gas price
projections. Consequently, **our PUN projections have been revised downward**, with reductions of approximately -2 €/MWh for 2025, -6 €/MWh
for 2026, and over 5 €/MWh for the post-2026 period. The anticipated
decline in power demand throughout the forecast horizon limits the
operability of CCGTs, thereby leading to a **reduction in Clean Spark Spread (CSS) expectations for thermoelectric plants**.
...
::: callout-right
Global LNG demand is projected to grow nearly 5% in 2025 and 2026,
driven primarily by Europe with almost 30 Bcm of regasification capacity
coming online (mainly in Germany) to replace Russian piped gas. In
contrast, LNG demand growth in China is expected to slow in 2025, due to
increased piped flows from Russia via the Power of Siberia pipeline
(almost 40 Bcm/y). For South and Southeast Asia, LNG will remain a
crucial baseload fuel to support rapidly expanding economic growth.
However, global LNG supply growth remains constrained in the short term,
as construction of LNG facilities, particularly in the US, faces
significant delays. This results in an overall tight market balance,
which could impact prices, mainly in winter.
:::
:::::
...
::: callout-right
Global LNG demand is expected to grow towards 660 Bcm by 2027, before
gradually slowing down and stabilizing below 5% year-on-year, in line
with a structural shift towards renewables for electricity generation
and global improvements in energy efficiency. Assuming no further
delays, the new wave of liquefaction capacity, primarily driven by the
US and Qatar, will be in full swing, effectively eliminating the risk of
market tightness and paving the way for a gradual normalization of
global LNG prices.
:::
:::::
...
assessment overall. However, we have revised European demand upwards and
slightly lowered the growth forecast for China, while global demand
continues to follow the trend projected in the previous scenario.
:::
:::::
...
HUB PRICE, WITH THE TTF SIGNIFICANTLY AFFECTING PSV TRENDS. IN THE LONG
RUN, WE FORESEE THE PSV ALIGNING WITH EUROPEAN PRICES, TARGETING 30
€/MWH BY 2030\*\*
:::
...
auctions, held in December 2020 as part of Terna's pilot initiative to
provide ultra-fast frequency regulation services, are expected to become
operational. In addition, the Capacity Market auction of 2024 started
the development of energy-intensive storage in the Italian market, with
over 1.5 GW of new storage capacity, mainly consisting of
energy-intensive systems with a duration of 4 hours, starting to enter
into the market.The ongoing installation of distributed storage capacity
could also lead to a total electrochemical storage capacity of more than
15 GWh.
:::
:::::
...
::: callout-right
The anticipated growth of storage capacity in the coming years will play
a pivotal role in integrating non-programmable renewable energy,
enhancing the stability and flexibility of the national electricity
system. Italy's PNIEC sets an ambitious target of 72 GWh of additional
storage capacity by 2030, spanning both utility-scale and distributed
projects. Utility-scale development will primarily focus on Southern
regions, where non-programmable renewable generation is most
concentrated. The Italian storage market currently boasts a substantial
pipeline of projects, either authorized or under evaluation, with their
realization heavily reliant on the support of regulated mechanisms. Key
among these is the MACSE auction, planned for mid-2025, which aims to
develop capacity predominantly in the South and on the islands. By 2030,
total BESS capacity, including both small-scale and utility-scale
systems, is projected to range between 48 and 65 GWh.
:::
:::::
