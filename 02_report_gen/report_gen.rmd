...
::: callout-right
Renewables become the main source in the mix with 70% share. Convenient
market conditions favoured energy intensive storage.
:::
:::
...
increasing rental costs. Other residual costs, such as design,
administration, internal development, engineering, mitigation works, and
contingencies, are highly project-dependent and account for nearly 30%
of the total solar CAPEX. This cost structure typically results in an
IRR of around 7% (base case considering South zone, pre-tax captured
prices, 30 years time horizon) for solar projects, with regional
variations according to different zonal captured prices. For
agri-voltaic projects, a markup of 20%-40% on the total investment cost
must be applied, leading to a lower expected IRR of around 6%.
:::
:::
